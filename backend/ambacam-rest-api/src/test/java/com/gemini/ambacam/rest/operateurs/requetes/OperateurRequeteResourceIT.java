package com.gemini.ambacam.rest.operateurs.requetes;
...
public class OperateurRequeteResourceIT extends ItBase {
	...
	public void listByOperateurFirstPageDefaultLimit() {
		given().queryParam("page", 0).get(ApiConstants.OPERATEUR_REQUETE_COLLECTION, operateur1.getId()).then()
	...
	public void listByOperateurLastPageDefaultLimit() {
		given().queryParam("page", 1).get(ApiConstants.OPERATEUR_REQUETE_COLLECTION, operateur1.getId()).then()
				.log().body().statusCode(200).body("size()", is(equalTo(1)))
	...
	public void listByOperateur() {
		given().queryParam("limit", 2).get(ApiConstants.OPERATEUR_REQUETE_COLLECTION, operateur1.getId()).then()
