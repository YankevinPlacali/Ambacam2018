...
public class RolesResourceIT extends ItBase {
	...
	public void createNomNull() {
		Role create = buildRole();
		create.setNom(null);
		given().contentType(ContentType.JSON).body(create).log().body().post(ApiConstants.ROLE_COLLECTION).then()
	...
	public void updateNotFound() {
		Role update = buildRole();
		given().contentType(ContentType.JSON).body(update).put(ApiConstants.ROLE_ITEM, random.nextLong()).then()
