...
import com.gemini.ambacam.repository.PassportRepository;
...
public class PassportsResourceIT extends ItBase {
	...
	public void getNotFound() {
		given().get(ApiConstants.PASSPORT_ITEM, operateur.getId(), requerant.getId(), requete1.getId(),
	...
	public void delete() {
		...
		given().delete(ApiConstants.PASSPORT_ITEM, operateur.getId(), requerant.getId(), requete1.getId(),
	...
	public void update() {
		...
		given().contentType(ContentType.JSON).body(updateTO).put(ApiConstants.PASSPORT_ITEM, operateur.getId(),
	...
	public void listByRequete() {
		given().get(ApiConstants.PASSPORT_COLLECTION, operateur.getId(), requerant.getId(), requete1.getId())
