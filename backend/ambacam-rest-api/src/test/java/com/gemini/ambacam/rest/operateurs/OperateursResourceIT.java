...
public class OperateursResourceIT extends ItBase {
	...
	public void createNomNull() {
		...
		given().contentType(ContentType.JSON).body(create).log().body().post(ApiConstants.OPERATEUR_COLLECTION)
	...
	public void findByUsername() {
		...
		given().contentType(ContentType.JSON).body(valueTO).log().body()
	...
	public void update() {
		...
		given().contentType(ContentType.JSON).body(update).put(ApiConstants.OPERATEUR_ITEM, operateur2.getId())
	...
	public void updateNotFound() {
		...
		given().contentType(ContentType.JSON).body(update).put(ApiConstants.OPERATEUR_ITEM, random.nextLong())
