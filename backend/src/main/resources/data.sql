...
INSERT INTO PUBLIC.REQUERANT(ID, CREE_LE, DATE_NAISSANCE, IDENTIFIER, LIEU_NAISSANCE, NOM, PRENOM, PROFESSION, SEXE, CREE_PAR_ID, NATIONALITE_ID) VALUES
(1, TIMESTAMP '2018-12-02 11:06:31.071', TIMESTAMP '2018-12-21 01:00:00', 'KSDHFSDF', 'Bafoussam', 'Kamga', 'Raymon', 'Etudiant', 'M', 1, 1),
(2, TIMESTAMP '2018-12-02 11:07:24.214', TIMESTAMP '2018-02-05 01:00:00', 'QHSDGHDS', 'Douala', 'Essome Ahanda', 'Ludwin', 'Inspecteur de police', 'F', 1, 1),
(3, TIMESTAMP '2018-12-02 11:10:00.494', TIMESTAMP '2018-12-12 01:00:00', 'IEWTSDRT', 'Yokadouma', 'Nga Onana', 'Stella', 'Etudiante', 'F', 1, 1);
