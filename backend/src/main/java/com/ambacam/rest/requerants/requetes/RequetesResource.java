...
public class RequetesResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public List<RequeteReadTO> listByOperateurAndRequerant(
            @QueryParam("limit") Integer limit,
            @QueryParam("page") Integer page,
            @PathVariable("operateurId") Long operateurId,
            @PathVariable("requerantId") Long requerantId) {
        log.info("List all requetes by operateurId and requerantId [operateurId={}, requerantId={}]", operateurId, requerantId);
