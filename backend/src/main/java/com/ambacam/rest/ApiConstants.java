...
public class ApiConstants {
	...
	public static final String OPERATEUR_REQUETE_GROUPE_ITEM_REQUETE_COLLECTION = OPERATEUR_REQUETE_GROUPE_ITEM
			+ "/requetes";
	...
	public static final String REQUETE_HISTORY_COLLECTION = REQUETE_BATCH_COLLECTION + "/history";
