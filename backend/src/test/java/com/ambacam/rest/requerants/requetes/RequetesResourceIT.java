...
public class RequetesResourceIT extends ItBase {
    ...
    public void create() {
        ...
        int id = given()
                ...
                .body(createTO)
                .log().body()
                .post(ApiConstants.REQUERANT_REQUETE_COLLECTION, operateur2.getId(), requerant1.getId())
                .then().log().body()
                .statusCode(200)
                .extract()
                .body()
    ...
    public void createRequerantNotFound() {
        ...
        given()
                ...
                .body(createTO)
                .log().body()
                .post(ApiConstants.REQUERANT_REQUETE_COLLECTION, operateur2.getId(), random.nextLong())
                .then().log().body()
                .statusCode(404);
    }
    ...
    public void createOperateurNotFound() {
        ...
        given()
                ...
                .body(createTO)
                .log().body()
                .post(ApiConstants.REQUERANT_REQUETE_COLLECTION, random.nextLong(), requerant1.getId())
                .then().log().body()
                .statusCode(404);
    }
    ...
    @Test
    public void get() {
        given().get(ApiConstants.REQUERANT_REQUETE_ITEM, operateur1.getId(), requerant1.getId(), requete1.getId())
                .then().log()
                .body()
                .statusCode(200)
    ...
    public void getNotFound() {
        given().get(ApiConstants.REQUERANT_REQUETE_ITEM, operateur1.getId(), requerant1.getId(), random.nextLong())
                .then()
                .statusCode(404);
    }
    ...
    public void delete() {
        ...
        given().delete(ApiConstants.REQUERANT_REQUETE_ITEM, operateur1.getId(), requerant1.getId(), requete1.getId())
                .then()
                .statusCode(200);
    ...
    public void deleteNotFound() {
        given()
                .delete(ApiConstants.REQUERANT_REQUETE_ITEM, operateur1.getId(), requerant1.getId(), random.nextLong())
                .then()
                .statusCode(404);
    }
    ...
    public void update() {
        ...
        given()
                .contentType(ContentType.JSON)
                .body(updateTO)
                .put(ApiConstants.REQUERANT_REQUETE_ITEM, operateur1.getId(), requerant1.getId(), requete1.getId())
                .then()
                .log().body()
                .statusCode(200);
    ...
    public void updateNotFound() {
        ...
        given()
                .contentType(ContentType.JSON)
                .body(updateTO)
                .put(ApiConstants.REQUERANT_REQUETE_ITEM, operateur1.getId(), requerant1.getId(), random.nextLong())
                .then()
                .log().body()
                .statusCode(404);
    }
    ...
    public void updateStatus() {
        ...
        given()
                .contentType(ContentType.JSON)
                .body(updateStatusTO)
                .put(ApiConstants.REQUERANT_REQUETE_ITEM_STATUS, operateur1.getId(), requerant1.getId(), requete1.getId())
                .then()
                .log().body()
                .statusCode(200);
    ...
    public void updateStatusNotFound() {
        ...
        given()
                .contentType(ContentType.JSON)
                .body(updateStatusTO)
                .put(ApiConstants.REQUERANT_REQUETE_ITEM_STATUS, operateur1.getId(), requerant1.getId(), random.nextLong())
                .then()
                .log().body()
                .statusCode(404);
    }
    ...
    public void listByOperateurAndRequerantFirstPageDefaultLimit() {
        given()
                .queryParam("page", 0)
                .get(ApiConstants.REQUERANT_REQUETE_COLLECTION, operateur1.getId(), requerant1.getId())
                .then()
                .log().body()
                .statusCode(200)
